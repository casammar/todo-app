...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
          [
              ...
              'status' => 'completed',
              'published' => 1,
              'created' => '2019-05-24 23:36:03',
              'modified' => '2019-05-24 23:36:03'
          ],
        ];
        parent::init();
    }
